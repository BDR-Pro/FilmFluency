...
class Movie(models.Model):
    ...
    budget = models.BigIntegerField(null=True, blank=True)  # Budget of the movie
    revenue = models.BigIntegerField(null=True, blank=True)  # Revenue generated by the movie
    runtime = models.IntegerField(null=True, blank=True)  # Runtime in minutes
    homepage = models.URLField(max_length=200, null=True, blank=True)  # Official homepage of the movie
    status = models.CharField(max_length=20, null=True, blank=True)  # Status of the movie, e.g., "Released"
    tagline = models.CharField(max_length=200, null=True, blank=True)  # Tagline of the movie
    production_companies = models.TextField(null=True, blank=True)  # JSON or list of production companies
    production_countries = models.TextField(null=True, blank=True)  # JSON or list of production countries
    spoken_languages = models.TextField(null=True, blank=True)  # JSON or list of spoken languages
    keywords = models.TextField(null=True, blank=True)  # JSON or list of keywords associated with the movie

    
    """
    def list_5000():
    Return a list of 5000 kaggle list of movies.
    os.chdir(os.path.dirname(os.path.abspath(__file__)))
    os.chdir("tmdb_csv")
    movie_id,title,cast,crew in a csv file (_credits.csv)
    budget,genres,homepage,id,keywords,original_language,original_title,overview,popularity,production_companies,production_countries,release_date,revenue,runtime,spoken_languages,status,tagline,title,vote_average,vote_count
    in a csv file (_movies.csv)
    """
